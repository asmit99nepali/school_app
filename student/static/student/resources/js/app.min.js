$(document).ready(function(){
    ...
    $('#showme').on('click', function() {
        ...
        if (x.type === "password") {
          x.type = "text";
          document.getElementById("showme").innerHTML = "<i class='zwicon-eye-slash'></i>";
        } else {
          x.type = "password";
          document.getElementById("showme").innerHTML = "<i class='zwicon-eye'></i>";
        }
    }); 
});
...
$(document).ready(function () {
  if ($('.navigation__sub') [0] && $('.navigation__sub > a').on('click', function (e) {
    e.preventDefault(),
    $(this).next('ul').stop(!0, !1).slideToggle(300)
  }), $('.search') [0]) {
    var e = $('.search__input');
    e.on('focus', function () {
...
$(document).ready(function () {
  if ($('#w-calendar-body') [0]) {
    ...
    $('.w-calendar__year').html(t.getFullYear()),
    $('.w-calendar__day').html(['Sunday',
    'Monday',
    'Tuesday',
    'Wednesday',
    'Thursday',
    'Friday',
    'Saturday'][t.getDay()] + ', ' + ['January',
    'February',
    'March',
    'April',
    'May',
    ...
    'October',
    'November',
    'December'][t.getMonth()].substring(0, 3) + ' ' + t.getDay())
  }
  if ($('#calendar') [0]) {
    var i,
    n,
    ...
    c = [
      ...
      },
      {
        id: 6,
        title: 'Sem Pharetra',
        start: new Date(s, r, 21),
        allDay: !0,
        description: 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.',
        classNames: 'bg-blue-grey'
      },
      {
        id: 7,
    ...
    d = new FullCalendar.Calendar(a, {
      ...
      datesRender: function () {
        var e = d.getDate();
        a.setAttribute('data-calendar-month', e.getMonth() + 1),
        o.innerText = d.view.title
      },
      ...
      eventClick: function (e) {
        ...
        t.modal('show'),
        t.find('.event-edit__color ' + a).button('toggle'),
        t.find('.event-new__title').val('').removeClass('is-invalid'),
  ...
  if ($('#input-slider-range') [0]) {
    ...
    a = [
      document.getElementById('input-slider-range-value-1'),
      document.getElementById('input-slider-range-value-2')
    ];
    noUiSlider.create(t, {
      start: [
        20,
  ...
  $('.stats') [0] && ($.plot($('.stats__student'), [
  ...
  }), $.plot($('.stats__parent'), [
    {
      ...
      lines: {
        ...
        fillColor: {
          colors: [
            'rgba(172, 102, 245, 0.0)',
            'rgba(172, 102, 245, 0.25)'
          ]
        }
      },
      data: [
