...
!function (e, t) {
  ...
  function t(e, t, n) {
    ...
    return 'string' == typeof n ? r.innerHTML = n : null != n && a(r, n),
    r
  }
  function n(e) {
    e = e.trim();
  ...
  function l(e) {
    return 'string' == typeof e ? r(e)  : e instanceof Node ? [
      e
  ...
  function p(e, t) {
    ...
    ], i = 0; i < n.length; i++) for (var o = n[i].querySelectorAll(t), a = 0; a < o.length; a++) r.push(o[a]);
    return r
  }
  function h(e, t) {
    for (var n = e instanceof HTMLElement ? [
    ...
    ], i = 0; i < n.length; i++) for (var o = n[i].children, a = 0; a < o.length; a++) {
      var s = o[a];
      t && !f(s, t) || r.push(s)
    }
    return r
  ...
  function C(e, t) {
    ...
    return w() && 'rtl' === n.direction ? l.scrollbarLeft = s : l.scrollbarRight = s,
    t && (l.paddingLeft = parseInt(n.paddingLeft, 10) || 0, l.paddingRight = parseInt(n.paddingRight, 10) || 0, l.paddingTop = parseInt(n.paddingTop, 10) || 0, l.paddingBottom = parseInt(n.paddingBottom, 10) || 0),
    l
  }
  function M(e, t) {
    void 0 === t && (t = !1);
    ...
    return t && (i.left += r.paddingLeft, i.right -= r.paddingRight, i.top += r.paddingTop, i.bottom -= r.paddingBottom),
    i
  }
  function k(e) {
  ...
  function ue(e, t) {
    var n;
    return 'string' == typeof e ? le(e)  : 'object' == typeof e && e ? ce(e)  : 'number' == typeof e ? ce((n = {
    }, n[t || 'milliseconds'] = e, n))  : null
  }
  function le(e) {
    var t = Ei.exec(e);
    if (t) {
  ...
  function Ue(e) {
    ...
    for ('string' == typeof e ? i = e.split(/\s*,\s*/)  : 'function' == typeof e ? i = [
      e
    ] : Array.isArray(e) && (i = e), t = 0; t < i.length; t++) n = i[t],
  ...
  function nt(e, t) {
    ...
    if (t) for (n = 0; n < t.length; n++) {
      for (r = t[n], i = [
      ], o = e.length - 1; o >= 0; o--) if ('object' == typeof (a = e[o][r]) && a) i.unshift(a);
       else if (void 0 !== a) {
        u[r] = a;
        break
      }
  ...
  function mt(e, t) {
    ...
    o = t.start;
    for (e.sort(Et), n = 0; n < e.length; n++) r = e[n],
    r.start > o && i.push({
      start: o,
      end: r.start
    }),
  ...
  function Mt(e) {
    ...
    n;
    return function () {
      return t && Ct(t, arguments) || (t = arguments, n = e.apply(this, arguments)),
      n
    }
  }
  function kt(e, t) {
  ...
  function _t(e, t, n) {
    ...
    return function (o) {
      var a,
      s = o.marker;
      return a = r && !s.getUTCMinutes() ? r : i,
      xt(a.format(s), o, e, t, n)
    }
  }
  function Pt(e, t) {
  ...
  function xt(e, t, n, r, i) {
    return e = e.replace(Ci, ''),
    'short' === n.timeZoneName && (e = Ht(e, 'UTC' === i.timeZone || null == t.timeZoneOffset ? 'UTC' : Ft(t.timeZoneOffset))),
    r.omitCommas && (e = e.replace(Ri, '').trim()),
    r.omitZeroMinute && (e = e.replace(':00', '')),
    !1 === r.meridiem ? e = e.replace(wi, '').trim()  : 'narrow' === r.meridiem ? e = e.replace(wi, function (e, t) {
  ...
  function Nt(e, t, n, r) {
    ...
    return 'narrow' === r ? i.push(t)  : 'short' === r && i.push(t, ' '),
  ...
  function At(e, t, n) {
    ...
    r.length > 10 && (null == t ? r = r.replace('Z', '')  : 0 !== t && (r = r.replace('Z', Ft(t, !0)))),
    r
  }
  function Bt(e) {
  ...
  function jt(e, t, n, r) {
    ...
    for (var c in e.defs) {
      var d = e.defs[c];
      'inverse-background' === d.rendering && (d.groupId ? (i[d.groupId] = [
      ], a[d.groupId] || (a[d.groupId] = d))  : o[c] = [
      ])
    }
  ...
  function $t(e, t, n, r, i) {
    ...
    n.extendedProps && (a.extendedProps = Di({
    }, a.extendedProps, n.extendedProps));
    for (var s = 0, u = r; s < u.length; s++) {
      (0, u[s]) (a, n, i)
    }
    return !a.hasEnd && i.opt('forceEventDuration') && (a.hasEnd = !0),
    a
  }
  function en(e, t) {
    return e && !Te(e) && (e = null),
    t && !Te(t) && (t = null),
  ...
  function tn(e, t, n, r, i) {
    ...
    return a && (u.range = Xe(u.range)),
    r.startDelta && n.startEditable && (u.range = {
  ...
  function an(e, t, n) {
    ...
    i = it(e.instances, function (e) {
      var i = r[e.defId];
      return i.allDay || i.recurringDef ? e : Di({
      }, e, {
        range: {
  ...
  function On(e, t, n, r, i) {
    ...
    return a.extendedProps = Di(o, a.extendedProps || {
    }),
  ...
  function Pn(e, t, n, r, i) {
    ...
    return null != s.end && (a = n.dateEnv.createMarkerMeta(s.end)),
  ...
  function Nn(e, t) {
    ...
    return null == n && (n = t.opt('allDayDefault')),
    n
  }
  function zn(e, t) {
    return st(Un(e), '', t)
  ...
  function An(e, t, n, r) {
    ...
    s,
    u = e.dateEnv;
    return t instanceof Date ? i = t : (i = t.date, o = t.type, a = t.forceOff),
    s = {
      date: u.formatIso(i, {
        omitTime: !0
      }),
    ...
    n = n ? ' ' + bn(n)  : '',
    r = r || '',
    !a && e.opt('navLinks') ? '<a' + n + ' data-goto="' + Dn(JSON.stringify(s)) + '">' + r + '</a>' : '<span' + n + '>' + r + '</span>'
  }
  function Bn(e) {
  ...
  function Fn(e, t, n, r) {
    ...
    return wt(t.activeRange, e) ? (c.push('fc-' + yi[e.getUTCDay()]), s.opt('monthMode') && l.getMonth(e) !== l.getMonth(t.currentRange.start) && c.push('fc-other-month'), i = X(a.getNow()), o = V(i, 1), e < i ? c.push('fc-past')  : e >= o ? c.push('fc-future')  : (c.push('fc-today'), !0 !== r && c.push(u.getClass('today'))))  : c.push('fc-disabled-day'),
    c
  }
  function Wn(e, t, n) {
    var r = !1,
  ...
  function $n(e, t, n, r) {
    for (var i = e ? ot(e)  : null, o = X(n.start), a = n.end, s = [
    ]; o < a; ) {
      var u = void 0;
  ...
  function nr(e) {
    for (var t = window.FullCalendarLocalesAll || [
  ...
  function rr(e, t) {
    return 'object' != typeof e || Array.isArray(e) ? ir(e, t)  : ar(e.code, [
      e.code
    ], e)
  }
  function ir(e, t) {
  ...
  function cr(e, t) {
    for (var n = t.pluginSystem.hooks.eventSourceDefs, r = n.length - 1; r >= 0; r--) {
      var i = n[r],
      o = i.parseMeta(e);
      if (o) return dr('object' == typeof e ? e : {
      }, o, r, t)
    }
    return null
  }
  ...
  function Tr(e, t, n) {
    for (var r = br(e.viewType, t), i = wr(e.dateProfile, t, e.currentDate, r, n), o = fr(e.eventSources, t, i, n), a = Di({
    }, e, {
      viewType: r,
      dateProfile: i,
  ...
  function Pr(e, t) {
    ...
    a = r.allDay;
    return null == a && (a = i && i.isTimeUnspecified && (!o || o.isTimeUnspecified)),
    n.range = {
  ...
  function jr(e, t, n) {
    ...
    return {
      ...
      singleUnit: a,
      options: Di({
      }, co, e.defaults, n.dirDefaults, n.localeDefaults, n.overrides, s, e.overrides, n.dynamicOverrides),
  ...
  function Yr(e, t) {
    ...
    this.dateEnv.formatRange(n.start, n.end, Vt(t.titleFormat || qr(e), t.titleRangeSeparator), {
  ...
  function ui(e, t, n, r, i, o, a, s) {
    ...
    h = [
      'fc-day-header',
      d.getClass('widgetHeader')
    ];
    return u = 'function' == typeof f.columnHeaderHtml ? f.columnHeaderHtml(c.toDate(e))  : Dn('function' == typeof f.columnHeaderText ? f.columnHeaderText(c.toDate(e))  : c.format(e, i)),
  ...
  function li(e, t) {
    ...
    return t ? n : {
      ...
      end: A(n.end, e.maxTime.milliseconds - 86400000)
    }
  }
  var ci = {
    className: !0,
  ...
  xi = function () {
    ...
    return e.prototype.setProp = function (e, t) {
      ...
      r;
      if (e in Ui);
       else if (e in zi) 'function' == typeof zi[e] && (t = zi[e](t)),
      this.mutate({
        standardProps: (n = {
        }, n[e] = t, n)
      });
  ...
  Wi = function (e) {
    ...
    t.prototype.on = function (e, t) {
      return Zn(this._handlers || (this._handlers = {
      }), e, t),
      this
    },
    t.prototype.one = function (e, t) {
      return Zn(this._oneHandlers || (this._oneHandlers = {
      }), e, t),
      this
    },
    t.prototype.off = function (e, t) {
      return this._handlers && jn(this._handlers, e, t),
    ...
    t.prototype.triggerWith = function (e, t, n) {
      return this._handlers && je(this._handlers[e], t, n),
      this._oneHandlers && (je(this._oneHandlers[e], t, n), delete this._oneHandlers[e]),
      this
    },
  ...
  var Qi = function (e) {
    ...
    t.prototype.triggerRenderedSegs = function (e, t) {
      ...
      n.state.loadingLevel || (n.afterSizingTriggers._eventsPositioned = [
        null
      ])
    },
  ...
  so = {
    parse: function (e, t, n, r) {
      ...
      var l;
      return l = !a.startTime && !a.endTime && (null == t || t),
      s ? {
        allDay: l,
  ...
  Do = function () {
    ...
    e.prototype.createMarkerMeta = function (e) {
      ...
      var t = null;
      return 'number' == typeof e ? t = this.timestampToMarker(e)  : e instanceof Date ? (e = e.valueOf(), isNaN(e) || (t = this.timestampToMarker(e)))  : Array.isArray(e) && (t = oe(e)),
      null !== t && ae(t) ? {
        marker: t,
        isTimeUnspecified: !1,
        forcedTzo: null
    ...
    e.prototype.toDate = function (e, t) {
      return 'local' === this.timeZone ? re(ie(e))  : 'UTC' === this.timeZone ? new Date(e.valueOf())  : this.namedTimeZoneImpl ? new Date(e.valueOf() - 1000 * this.namedTimeZoneImpl.offsetForArray(ie(e)) * 60)  : new Date(e.valueOf() - (t || 0))
    },
    e
  }(),
  To = {
  ...
  Ro = function () {
    ...
    e.prototype.buildRangeFromDuration = function (e, t, n, r) {
      ...
      return d || (o = this.options.dateIncrement, o ? (a = ue(o), d = Te(a) < Te(n) ? we(a, !de(o)).unit : r)  : d = r),
      Ee(n) <= 1 && this.isHiddenDay(s) && (s = this.skipHiddenDays(s, t), s = X(s)),
      i(),
  ...
  Mo = function (e) {
    function r(n, r) {
      ...
      return i._renderLayout = Ln(i.renderLayout, i.unrenderLayout),
      i._updateTitle = Ln(i.updateTitle, null, [
        i._renderLayout
      ]),
      i._updateActiveButton = Ln(i.updateActiveButton, null, [
        i._renderLayout
      ]),
      i._updateToday = Ln(i.updateToday, null, [
        i._renderLayout
      ]),
      i._updatePrev = Ln(i.updatePrev, null, [
        i._renderLayout
      ]),
      i._updateNext = Ln(i.updateNext, null, [
        i._renderLayout
      ]),
      i.el = t('div', {
      ...
      return r && r.split(' ').forEach(function (e, t) {
        ...
        if (e.split(',').forEach(function (e, t) {
          ...
          'title' === e ? (o.push(n('<h2>&nbsp;</h2>')), l = !1)  : ((r = f[e]) ? (d = function (e) {
            ...
            u[e]()
          }, (g = p[e]) || (v = s.getIconClass(e)) || (g = h[e])), d && (m = [
            'fc-' + e + '-button',
            s.getClass('button')
          ], g ? (y = Dn(g), S = '')  : v && (y = '<span class=\'' + v + '\'></span>', S = ' aria-label="' + e + '"'), E = n('<button type="button" class="' + m.join(' ') + '"' + S + '>' + y + '</button>'), E.addEventListener('click', d), o.push(E)))
        }), o.length > 1) {
  ...
  ko = function (e) {
    ...
    n.prototype.render = function (e) {
      ...
      this._renderToolbars(e.viewSpec, e.dateProfile, e.currentDate, e.dateProfileGenerator, t),
      this.renderView(e, t),
      this.updateSize(),
      this.thawHeight()
    },
    n.prototype.renderToolbars = function (e, t, n, r, i) {
      ...
      o ? (this.header || (this.header = new Mo(this.context, 'fc-header-toolbar'), s(this.el, this.header.el)), this.header.receiveProps(Di({
        layout: o
      }, p)))  : this.header && (this.header.destroy(), this.header = null),
      u ? (this.footer || (this.footer = new Mo(this.context, 'fc-footer-toolbar'), a(this.el, this.footer.el)), this.footer.receiveProps(Di({
        layout: u
    ...
    n.prototype.computeHeightVars = function () {
      ...
      this.viewHeight = 'number' == typeof n ? n : 'function' == typeof n ? n()  : 'number' == typeof t ? t - this.queryToolbarsHeight()  : 'function' == typeof t ? t() - this.queryToolbarsHeight()  : 'parent' === t ? this.el.parentNode.offsetHeight - this.queryToolbarsHeight()  : Math.round(this.contentEl.offsetWidth / Math.max(e.opt('aspectRatio'), 0.5))
    },
    n.prototype.queryToolbarsHeight = function () {
      var e = 0;
      return this.header && (e += _(this.header.el)),
  ...
  Po = function (e) {
    function t(t) {
      ...
      var r = t.component;
      return n.destroy = N(r.el, 'click', r.fgSegSelector + ',' + r.bgSegSelector, n.handleSegClick),
      n
    }
    return tt(t, e),
    t
  ...
  xo = function (e) {
    function t(t) {
      ...
      var r = t.component;
      return n.removeHoverListeners = z(r.el, r.fgSegSelector + ',' + r.bgSegSelector, n.handleSegEnter, n.handleSegLeave),
  ...
  var No = function () {
    function e(e, t) {
      ...
      for (var r = tr(this.optionsManager.computed.plugins || [
    ...
    e.prototype.unbindHandlers = function () {
      ...
      this.windowResizeProxy && (window.removeEventListener('resize', this.windowResizeProxy), this.windowResizeProxy = null)
    },
    ...
    e.prototype.dispatch = function (e) {
      if (this.actionQueue.push(e), !this.isReducing) {
        ...
        var n = this.state;
        this.isReducing = !1,
        !t.loadingLevel && n.loadingLevel ? this.publiclyTrigger('loading', [
          !0
        ])  : t.loadingLevel && !n.loadingLevel && this.publiclyTrigger('loading', [
          !1
        ]);
        ...
        (t.viewType !== n.viewType || this.needsFullRerender) && (t.viewType && r && this.publiclyTrigger('viewSkeletonDestroy', [
          {
            view: r,
            el: r.el
          }
    ...
    e.prototype.renderComponent = function (e) {
      ...
      this.isViewUpdated && (this.isViewUpdated = !1, this.publiclyTrigger('viewSkeletonRender', [
        {
          view: r.view,
          el: r.view.el
        }
    ...
    e.prototype.setOption = function (e, t) {
      ...
      this.handleOptions(this.optionsManager.computed),
      'height' === e || 'contentHeight' === e || 'aspectRatio' === e ? this.updateSize()  : 'defaultDate' === e || 'defaultView' === e || /^(event|select)(Overlap|Constraint|Allow)$/.test(e) || (this.needsFullRerender = !0, this.batchRendering(function () {
    ...
    e.prototype.changeView = function (e, t) {
      var n = null;
      t && (t.start && t.end ? (this.optionsManager.add('visibleRange', t), this.handleOptions(this.optionsManager.computed))  : n = this.dateEnv.createMarker(t)),
      this.unselect(),
      this.dispatch({
        type: 'SET_VIEW_TYPE',
        viewType: e,
    ...
    e.prototype.windowResize = function (e) {
      !this.isHandlingWindowResize && this.component && e.target === window && (this.isHandlingWindowResize = !0, this.updateSize(), this.publiclyTrigger('windowResize', [
        this.view
    ...
    e.prototype.buildDatePointApi = function (e) {
      for (var t = {
      }, n = 0, r = this.pluginSystem.hooks.datePointTransforms; n < r.length; n++) {
        var i = r[n];
        Di(t, i(e, this))
      }
      return Di(t, zr(e, this.dateEnv)),
      t
    },
    e.prototype.buildDateSpanApi = function (e) {
      for (var t = {
      }, n = 0, r = this.pluginSystem.hooks.dateSpanTransforms; n < r.length; n++) {
        var i = r[n];
        Di(t, i(e, this))
      }
      return Di(t, Nr(e, this.dateEnv)),
      t
    },
    ...
    e.prototype.getDefaultEventEnd = function (e, t) {
      var n = t;
      return e ? (n = X(n), n = this.dateEnv.add(n, this.defaultAllDayEventDuration))  : n = this.dateEnv.add(n, this.defaultTimedEventDuration),
      n
    },
  ...
  var zo = function (e) {
    function n(n, r, i, o) {
      ...
      a.renderBusinessHoursMem = Ln(a.renderBusinessHours, a.unrenderBusinessHours, [
        a.renderDatesMem
      ]),
      a.renderDateSelectionMem = Ln(a.renderDateSelectionWrap, a.unrenderDateSelectionWrap, [
        a.renderDatesMem
      ]),
      a.renderEventsMem = Ln(a.renderEvents, a.unrenderEvents, [
        a.renderDatesMem
      ]),
      a.renderEventSelectionMem = Ln(a.renderEventSelectionWrap, a.unrenderEventSelectionWrap, [
        a.renderEventsMem
      ]),
      a.renderEventDragMem = Ln(a.renderEventDragWrap, a.unrenderEventDragWrap, [
        a.renderDatesMem
      ]),
      a.renderEventResizeMem = Ln(a.renderEventResizeWrap, a.unrenderEventResizeWrap, [
        a.renderDatesMem
      ]),
      a.viewSpec = r,
    ...
    n.prototype.queryScroll = function () {
      ...
      return this.props.dateProfile && Di(e, this.queryDateScroll()),
      e
    },
    n.prototype.applyScroll = function (e, t) {
      e.isDateInit && (delete e.isDateInit, this.props.dateProfile && Di(e, this.computeInitialDateScroll())),
  ...
  var Uo = function () {
    ...
    e.prototype.rangeUpdated = function () {
      ...
      this.eventTimeFormat = Vt(n.eventTimeFormat || this.computeEventTimeFormat(), n.defaultRangeSeparator),
    ...
    e.prototype._getTimeText = function (e, t, n, r, i, o, a) {
      ...
      this.displayEventTime && !n ? i && t ? s.formatRange(e, t, r, {
        forcedStartTzo: o,
        forcedEndTzo: a
      })  : s.format(e, r, {
        forcedTzo: o
  ...
  Lo = function () {
    ...
    e.prototype.renderSegs = function (e, t) {
      ...
      i && (n = this.containerElsByType[e] || (this.containerElsByType[e] = [
      ])).push.apply(n, i),
      this.segsByType[e] = r,
    ...
    e.prototype.renderSegHtml = function (e, t) {
      ...
      '<' + this.fillSegTag + (r.length ? ' class="' + r.join(' ') + '"' : '') + (n ? ' style="' + Tn(n) + '"' : '') + '></' + this.fillSegTag + '>'
    },
  ...
  Wo = function (e) {
    function t(t, r) {
      ...
      return r.innerHTML = '',
      r.appendChild(i.el = n('<div class="fc-row ' + i.theme.getClass('headerRow') + '"><table class="' + i.theme.getClass('tableGrid') + '"><thead></thead></table></div>')),
  ...
  Zo = function () {
    function e(e, t) {
      ...
      ], a = - 1; n < r; ) t.isHiddenDay(n) ? i.push(a + 0.5)  : (a++, i.push(a), o.push(n)),
      n = V(n, 1);
      this.dates = o,
      this.indices = i,
      this.cnt = o.length
  ...
  jo = function () {
    ...
    return e.prototype.buildCells = function () {
      for (var e = [
        ...
        for (var n = [
        ], r = 0; r < this.colCnt; r++) n.push(this.buildCell(t, r));
        e.push(n)
      }
      return e
    },
    ...
    e.prototype.buildHeaderDates = function () {
      for (var e = [
      ], t = 0; t < this.colCnt; t++) e.push(this.cells[0][t].date);
      return e
    },
  ...
  Yo = function () {
    ...
    return e.prototype.sliceProps = function (e, t, n, r) {
      for (var i = [
      ], o = 4; o < arguments.length; o++) i[o - 4] = arguments[o];
      var a = e.eventUiBases,
      s = this.sliceEventStore.apply(this, [
        e.eventStore,
        a,
        t,
        n,
    ...
    e.prototype._sliceBusinessHours = function (e, t, n, r) {
      ...
      return e ? this._sliceEventStore.apply(this, [
        lt(e, li(t, Boolean(n)), r.calendar),
        {
        },
        t,
        n,
    ...
    e.prototype._sliceEventStore = function (e, t, n, r, i) {
      for (var o = [
      ], a = 5; a < arguments.length; a++) o[a - 5] = arguments[a];
      if (e) {
    ...
    e.prototype._sliceDateSpan = function (e, t, n) {
      for (var r = [
      ], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
      if (!e) return [];
      for (var o = Ur(e, t, n.calendar), a = this.sliceRange.apply(this, [
        e.range
      ].concat(r)), s = 0, u = a; s < u.length; s++) {
        var l = u[s];
        l.component = n,
        l.eventRange = o
      }
    ...
    e.prototype.sliceEventRange = function (e, t, n) {
      for (var r = this.sliceRange.apply(this, [
        e.range
      ].concat(n)), i = 0, o = r; i < o.length; i++) {
        var a = o[i];
        a.component = t,
        a.eventRange = e,
